...
ActiveRecord::Schema.define(version: 2019_05_01_212144) do
  ...
  create_table "board_follows", force: :cascade do |t|
    ...
    t.index ["following_id"], name: "index_board_follows_on_following_id"
    t.index ["user_id"], name: "index_board_follows_on_user_id"
  end
